/* Generated By:JavaCC: Do not edit this line. FunkyTacoJavaParser.java */
import syntaxtree.*;
import java.util.Vector;


public class FunkyTacoJavaParser implements FunkyTacoJavaParserConstants {
  ...
  static final public RhsExpression RhsExpression() throws ParseException {
   NodeChoice n0;
   DotExpression n1;
   Expression n2;
    if (jj_2_8(2147483647)) {
     ...
     {if (true) return new RhsExpression(n0);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public MessageSendStatement MessageSendStatement() throws ParseException {
   ...
   InlineAnn n1;
   NodeChoice n2;
   VoidMessageSendStmt n3;
   RetMessageSendStmt n4;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SCOMMENT1:
      n1 = InlineAnn();
        n0.addNode(n1);
    ...
    if (jj_2_9(2147483647)) {
      n3 = VoidMessageSendStmt();
           n2 = new NodeChoice(n3, 0);
    } else if (jj_2_10(2147483647)) {
      n4 = RetMessageSendStmt();
           n2 = new NodeChoice(n4, 1);
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
     {if (true) return new MessageSendStatement(n0,n2);}
    throw new Error("Missing return statement in function");
  }

  static final public VoidMessageSendStmt VoidMessageSendStmt() throws ParseException {
   MessageSend n0;
   NodeToken n1;
   Token n2;
    n0 = MessageSend();
    n2 = jj_consume_token(SEMICOLON);
            n1 = JTBToolkit.makeNodeToken(n2);
     {if (true) return new VoidMessageSendStmt(n0,n1);}
    throw new Error("Missing return statement in function");
  }

  static final public RetMessageSendStmt RetMessageSendStmt() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   MessageSend n3;
   ...
   Token n5;
    ...
    n5 = jj_consume_token(SEMICOLON);
            n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new RetMessageSendStmt(n0,n1,n3,n4);}
    throw new Error("Missing return statement in function");
  }

  static final public InlineAnn InlineAnn() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n5;
    n1 = jj_consume_token(SCOMMENT1);
                    n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(INLINE);
                 n2 = JTBToolkit.makeNodeToken(n3);
    n5 = jj_consume_token(SCOMMENT2);
                    n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new InlineAnn(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  static public FunkyTacoJavaParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x800000,0x78201000,0x800000,0x80400000,0x0,0x80400000,0x0,0x80400000,0x78201000,0x0,0x80400000,0x1000,0x78200000,0x78201000,0x8200000,0x0,0x8200000,0x0,0x0,0x8000000,0x200000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0xcb84,0x0,0x8000,0x8,0x8000,0x8,0x8000,0xcb84,0x40000,0x8000,0x0,0xcb84,0xcb84,0xc184,0x800,0xc184,0x8000,0x40000,0xc180,0x4,};
   }
  ...
  public FunkyTacoJavaParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public FunkyTacoJavaParser(java.io.InputStream stream, String encoding) {
    ...
    token_source = new FunkyTacoJavaParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public FunkyTacoJavaParser(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public FunkyTacoJavaParser(FunkyTacoJavaParserTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(FunkyTacoJavaParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
