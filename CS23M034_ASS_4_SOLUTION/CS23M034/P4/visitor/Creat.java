...
public class Creat<R,A> implements GJVisitor<R,A> {
   //
   ...
   Map<String, Map<String,String>> InfoVariable = new HashMap<>();
   Map<String, String> InfoReturn = new HashMap<>();
  ...
  Boolean flag =false;
   ...
   public R visit(Goal n, A argu) {
      ...
      InfoReturn = Il.InfoReturn;
      Field_var = Il.Field_var;
   ...
   public R visit(MainClass n, A argu) {
      ...
      if (InfoVariable.containsKey(node))
      {
        for(String key:InfoVariable.get(node).keySet())
        {
            ans += "    " + InfoVariable.get(node).get(key) + " " + key + " ;\n";
        }
      }
      
      n.f15.accept(this, argu);
      if (InfoInline.containsKey(node))
      {
         String str = InfoInline.get(node);
         str = str.replaceAll("_this", "this");
      ...
      if (InfoReturn.containsKey(node))
      {
          ans += "return " + InfoReturn.get(node) + " ;\n";
      }
      ans += "}\n}\n";
      return _ret;
   }
   ...
   public R visit(VarDeclaration n, A argu) {
      ...
      if (flag)
      {
          ans += r1.toString() + " " + n.f1.f0.toString() + " ;\n";
      }
      return _ret;
   }
   ...
   public R visit(MethodDeclaration n, A argu) {
       ...
       if (InfoInline.containsKey(node))
       {
           String type = InfoVariable.get(node).get(InfoReturn.get(node));
           ans += "    public " + type + " " + MethodName + " (";
            n.f0.accept(this, argu);
            n.f1.accept(this, argu);
            n.f2.accept(this, argu);
            n.f3.accept(this, argu);
   ...
   public R visit(FormalParameter n, A argu) {
      ...
      n.f1.accept(this, argu);
      String id = Method_var.get(ClassName).get(MethodName).get(n.f1.f0.toString()).get(1);
      ans += _ret.toString() + " " + id;
